      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold mb-4">About StyleAura</h3>
              <p className="text-gray-400 text-sm">Your one-stop shop for premium products across all categories.</p>
            </div>
            <div>
              <h3 className="font-bold mb-4">Categories</h3>
              <ul className="text-gray-400 text-sm space-y-2">
                <li>
                  <Link href={'/product/listing/all-products'} className="hover:text-white">All Products</Link>
                </li>
                <li>
                  <Link href="/product/listing/men" className="hover:text-white">
                    Men
                  </Link>
                </li>
                <li>
                  <Link href="product/listing/women" className="hover:text-white">
                    Women
                  </Link>
                </li>
                <li>
                  <Link href="product/listing/kids" className="hover:text-white">
                    Kids
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2024 StyleAura. All rights reserved - Sushant Gaikwad</p>
          </div>
        </div>
      </footer>
    </main>
